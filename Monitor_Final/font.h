...
// Fuente básica 8x8 ASCII (Del caracter 32 al 127)
const uint8_t font8x8[96][8] = {
    ...
    {0x7C,0xC6,0xC6,0xC6,0xDA,0xCC,0x7A,0x00}, // 81 Q
    {0xFC,0x66,0x66,0x7C,0x6C,0x66,0xE6,0x00}, // 82 R
    {0x7C,0xC6,0xE0,0x7C,0x0E,0xC6,0x7C,0x00}, // 83 S
    {0xFE,0x92,0x10,0x10,0x10,0x10,0x38,0x00}, // 84 T
    ...
    {0x00,0x18,0x3C,0x66,0x00,0x00,0x00,0x00}, // 94 ^
    ...
    {0x1C,0x30,0x30,0x7C,0x30,0x30,0x78,0x00}, // 102 f
    ...
    {0x00,0x00,0x7C,0x66,0x66,0x7C,0x60,0xF0}, // 112 p
    {0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0x0F}, // 113 q
    {0x00,0x00,0x6C,0x76,0x60,0x60,0xF0,0x00}, // 114 r
    ...
    {0x00,0x10,0x38,0x6C,0xC6,0xFE,0x00,0x00}  // 127 Delete
};
